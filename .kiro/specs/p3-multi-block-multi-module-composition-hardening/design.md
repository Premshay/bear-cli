...
| `reachPriorityOverTestFailure` (edge-case) | integration | Req 3.4 |
...
Property-based tests use [jqwik](https://jqwik.net/) (already on the test classpath
for existing property tests). Each property test runs a minimum of 100 iterations.

Tag format: `Feature: p3-multi-block-multi-module-composition-hardening, Property N: <text>`

| Property | Test method | Iterations |
|---|---|---|
| P2: Block selection is lexicographic | `blockSelectionIsLexicographicRegardlessOfIndexOrder` | 100 |
| P10: Index order independence | `graphResolutionIsOrderIndependent` | 100 |
